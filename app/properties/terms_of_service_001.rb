...
class TermsOfService001
  CONTENT =
%^本利用規約(以下「本規約」といいます。)には、株式会社Economica(以下「当社」といいます。)の提供するソーシャル英語学習サービス「Funglish（ファングリッシュ）」のご利用にあたり、登録ユーザーの皆様に遵守していただかなければならない事項及び当社と登録ユーザーの皆様との間の権利義務関係が定められております。当該サービスを登録ユーザーとしてご利用になる方は、本規約に同意する前に、必ず全文お読み下さいますようお願い致します。

<span class="article">第1条 適用</span>
...
<span class="article">第2条 定義</span>
本規約において使用する以下の用語は各々以下に定める意味を有するものとします。
(1) 「知的財産権」とは、著作権、特許権、実用新案権、商標権、意匠権その他の知的財産権(それらの権利を取得し、又はそれらの権利につき登録等を出願する権利を含みます。)を意味します。
(2) 「当社ウェブサイト」とは、そのドメインが「funglish.jp」である当社が運営するウェブサイト(理由の如何を問わず当社のウェブサイトのドメイン又は内容が変更された場合は、当該変更後のウェブサイトを含みます。)を意味します。
...
(6) 「本サービス」とは、当社が提供する「Funglish（ファングリッシュ）」という名称のソーシャル英語学習サービス(理由の如何を問わずサービスの名称又は内容が変更された場合は、当該変更後のサービスを含みます。)を意味します。
(7) 「利用契約」とは、第3条第3項に基づき当社と登録ユーザーの間で成立する、本規約の諸規定に従った本サービスの利用契約を意味します。

<span class="article">第3条 登録</span>
...
<span class="article">第4条 登録情報の変更</span>
登録ユーザーは、登録情報に変更があった場合は、遅滞なく、当社の定める方法により、当該変更事項を当社に通知し、当社から要求された資料を提出するものとします。

<span class="article">第5条 パスワード及びユーザーIDの管理</span>
...
<span class="article">第6条 本サービスの利用</span>
...
<span class="article">第7条 禁止行為</span>
...
<span class="article">第8条 本サービスの停止等</span>
...
<span class="article">第9条 ダウンロード等についての注意事項</span>
...
<span class="article">第10条 権利帰属</span>
...
<span class="article">第11条 登録取消等</span>
...
4. 登録ユーザーは、14日前までに当社所定の方法で当社に通知することにより、自己の登録ユーザーとしての登録を取り消すことができます。

<span class="article">第12条 保証の否認及び免責</span>
1. 当社は、英語教育サービスの提供につき如何なる保証も行うものではありません。さらに、登録ユーザーが当社から直接又は間接に本サービス又は他の登録ユーザーに関する情報を得た場合であっても、当社は登録ユーザーに対し本規約において規定されている内容を超えて如何なる保証も行うものではありません。
2. 登録ユーザーは、本サービスを利用することが、登録ユーザーに適用のある法令、業界団体の内部規則等に違反するか否かを自己の責任と費用に基づいて調査するものとし、当社は、登録ユーザー
による本サービスの利用が、登録ユーザーに適用のある法令、業界団体の内部規則等に適合することを何ら保証するものではありません。
...
<span class="article">第13条 紛争処理及び損害賠償</span>
1. 登録ユーザーは、本規約に違反することにより、又は本サービスの利用に関連して当社に損害を与えた場合、当社に対しその損害を賠償しなければなりません。
2. 当社は、本サービスに関連して登録ユーザーが被った損害について、一切賠償の責任を負いません。なお、消費者契約法の適用その他の理由により、本項その他当社の損害賠償責任を免責する規定にかかわらず当社が登録ユーザーに対して損害賠償責任を負う場合においても、当社の賠償責任は、損害の事由が生じた時点から遡って過去6ヶ月の期間に登録ユーザーから現実に受領した本サービスの利用料金の総額を上限とします。

<span class="article">第14条 秘密保持</span>
...
<span class="article">第19条 分離可能性</span>
...
<span class="article">第20条 存続規定</span>
第5条第2項、第6条(未払がある場合に限ります。)、第8条第2項、第9条第3項、第10条、第11条、第12条第2項及び第3項、第13条から第15条まで、並びに第19条から第22条までの規定は利用契約の終了後も有効に存続するものとします。但し、第15条については、利用契約終了後1年間に限り存続するものとします。

<span class="article">第21条 準拠法及び管轄裁判所</span>
本規約の準拠法は日本法とし、本規約に起因し又は関連する一切の紛争については、東京地方裁判所を第一審の専属的合意管轄裁判所とします。

<span class="article">第22条 協議解決</span>
