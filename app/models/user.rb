...
class User < ActiveRecord::Base
  ...
  def user_name_add_kana
    user_name + I18n.t("beginning_parenthesis") + user_name_kana + I18n.t("enging_parenthesis")
  end
